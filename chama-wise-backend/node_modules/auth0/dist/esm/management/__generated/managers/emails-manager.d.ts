...
import type { EmailProvider, EmailProviderCreate, EmailProviderUpdate, GetProviderRequest } from '../models/index.js';
...
export declare class EmailsManager extends BaseAPI {
     ...
     */
    get(requestParameters?: GetProviderRequest, initOverrides?: InitOverride): Promise<ApiResponse<EmailProvider>>;
    /**
     ...
     * @throws {RequiredError}
     */
    update(bodyParameters: EmailProviderUpdate, initOverrides?: InitOverride): Promise<ApiResponse<EmailProvider>>;
    /**
     ...
     * @throws {RequiredError}
     */
    configure(bodyParameters: EmailProviderCreate, initOverrides?: InitOverride): Promise<ApiResponse<EmailProvider>>;
}
export {};
