...
exports.parseFormParam = exports.CustomDomainHeader = exports.applyQueryParams = exports.validateRequiredRequestParams = exports.COLLECTION_FORMATS = exports.BaseAPI = void 0;
        ...
        this.fetch = async (url, init) => {
            ...
            if (error || !response.ok) {
                ...
                if (response === undefined) {
                    throw new errors_js_1.FetchError(error, (_b = error === null || error === void 0 ? void 0 : error.message) !== null && _b !== void 0 ? _b : 'The request failed and the interceptors did not return an alternative response');
                }
            }
            else {
                for (const middleware of this.middleware) {
