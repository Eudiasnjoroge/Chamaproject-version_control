...
import type { CustomDomain, GetCustomDomains200Response, PatchCustomDomainsByIdRequest, PostCustomDomains201Response, PostCustomDomainsRequest, PostVerify200Response, DeleteCustomDomainsByIdRequest, GetCustomDomainsRequest, GetCustomDomainsByIdRequest, PatchCustomDomainsByIdOperationRequest, PostVerifyRequest } from '../models/index.js';
...
export declare class CustomDomainsManager extends BaseAPI {
     ...
     */
    delete(requestParameters: DeleteCustomDomainsByIdRequest, initOverrides?: InitOverride): Promise<ApiResponse<void>>;
    /**
     ...
     * @throws {RequiredError}
     */
    getAll(requestParameters?: GetCustomDomainsRequest, initOverrides?: InitOverride): Promise<ApiResponse<GetCustomDomains200Response>>;
    /**
     ...
     * @throws {RequiredError}
     */
    get(requestParameters: GetCustomDomainsByIdRequest, initOverrides?: InitOverride): Promise<ApiResponse<CustomDomain>>;
    /**
     ...
     * @throws {RequiredError}
     */
    update(requestParameters: PatchCustomDomainsByIdOperationRequest, bodyParameters: PatchCustomDomainsByIdRequest, initOverrides?: InitOverride): Promise<ApiResponse<PostCustomDomains201Response>>;
    /**
     ...
     * @throws {RequiredError}
     */
    create(bodyParameters: PostCustomDomainsRequest, initOverrides?: InitOverride): Promise<ApiResponse<PostCustomDomains201Response>>;
    /**
     ...
     * @throws {RequiredError}
     */
    verify(requestParameters: PostVerifyRequest, initOverrides?: InitOverride): Promise<ApiResponse<PostVerify200Response>>;
}
export {};
